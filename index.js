...
app.get('/api/stats/:username', async (req, res) => {
  ...
  console.log({ curRepos, curFollowers, curFollowing, curStars });
  ...
  while (value > 0) {
    ...
    totalRepos += curRepos;
    page += 1;
    console.log({ curStars, curFollowers, curFollowing, curRepos });
    value = curStars || curFollowers || curFollowing || curRepos;
    console.log(value);
  }
  res.json({
